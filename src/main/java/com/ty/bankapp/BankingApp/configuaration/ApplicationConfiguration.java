...
public class ApplicationConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		contact.setEmail("email@bankingapp.in");
		contact.setName("Banking Application");
		contact.setUrl("https://bankingapp");

		License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

		Info info = new Info().title("BankinApp RESTful Web Service documentation").version("1.0").contact(contact)
				.description("This API exposes endpoints to manage Application.")
				.termsOfService("https://bankingapp/terms").license(mitLicense);
